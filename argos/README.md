...
Argos. Pour travailler sans le vrai service, lancer `npm run notif:mock` et renseigner
`NOTIF_API_URL=http://localhost:4010` dans `.env` (voir `.env.example`). Une notification qui
